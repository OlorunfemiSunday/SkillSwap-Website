...
const userProfiles = {
  "": {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1769273636/Frame_2147258844_fcumnu.png",
    progress: 75,
  ...
  uiux: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1768977153/Frame_90_nedzzq.png",
    progress: 85,
  ...
  webdev: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1768977607/Frame_90_1_frwzqs.png",
    progress: 90,
  ...
  marketing: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1769525997/e930d9716f3b2adcad4147fe369fdbf9619a93f1_oycg4d.jpg",
    progress: 80,
  ...
  graphicdesign: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1769525959/white_guy_passport_mxpkpb.png",
    progress: 88,
  ...
  dataanalytics: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1769525925/girl_passport_kt7nmi.png",
    progress: 92,
  ...
  contentwriting: {
    ...
    image:
      "https://res.cloudinary.com/dezoqbzim/image/upload/v1768977923/Frame_90_2_l0d76y.png",
    progress: 78,
...
const collaborations = [
  // UI/UX Design
  {
    ...
    description:
      "We are seeking an experienced UI/UX designer to create a visually appealing and user-friendly mobile application. The ideal candidate will have a strong portfolio showcasing their design skills and an understanding of user experience principles for iOS and Android platforms.",
  ...
  },
  {
    ...
    description:
      "We are seeking an experienced UI/UX designer to create a visually appealing and user-friendly landing page for our upcoming product launch. The ideal candidate will have a strong portfolio showcasing their design skills and an understanding of user experience principles.",
  ...
  },
  {
    ...
    description:
      "Looking for a skilled UX researcher to conduct user interviews, usability testing, and create detailed user personas for our SaaS product. Experience with both qualitative and quantitative research methods required.",
  ...
  // Web Development
  {
    ...
    description:
      "Seeking a talented React developer to build responsive and interactive web interfaces. Must have expertise in React, TypeScript, and modern frontend development practices. Experience with state management and API integration is essential.",
  ...
  },
  {
    ...
    description:
      "We need an experienced backend developer to design and implement RESTful APIs for our web platform. Strong knowledge of Node.js, Express, and database design required. Must be comfortable working with microservices architecture.",
  ...
  },
  {
    ...
    description:
      "Looking for a versatile full stack developer to build an e-commerce platform from scratch. Must be proficient in both frontend (React) and backend (Node.js) technologies, with experience in payment gateway integration.",
    tags: [
      "Web Development",
      "Full Stack",
      "E-commerce",
  ...
  // Marketing
  {
    ...
    description:
      "Seeking a creative digital marketing specialist to develop and execute comprehensive marketing strategies. Must have proven experience with SEO, content marketing, and conversion optimization for B2B and B2C audiences.",
  ...
  },
  {
    ...
    description:
      "We are looking for an experienced social media manager to create engaging content and manage our social media presence across multiple platforms. Must have experience with Facebook, Instagram, LinkedIn, and Twitter advertising.",
  ...
  },
  {
    ...
    description:
      "Need an email marketing expert to design and implement automated email campaigns. Experience with Mailchimp, HubSpot, or similar platforms required. Must understand customer journey mapping and segmentation strategies.",
  ...
  // Graphic Design
  {
    ...
    description:
      "Seeking a talented graphic designer to create a complete brand identity including logo, color palette, typography, and brand guidelines. Must have a portfolio demonstrating strong conceptual thinking and visual design skills.",
  ...
  },
  {
    ...
    description:
      "Looking for a creative illustrator to produce custom illustrations for our marketing campaigns and website. Experience with both digital and traditional illustration techniques preferred. Adobe Illustrator and Procreate proficiency required.",
  ...
  // Data Analytics
  {
    ...
    description:
      "We need a skilled Business Intelligence analyst to create interactive dashboards and reports using Tableau or Power BI. Must have experience with data visualization best practices and the ability to translate complex data into actionable insights.",
  ...
  },
  {
    ...
    description:
      "Seeking an experienced data scientist to build machine learning models for customer behavior prediction. Strong Python skills and experience with scikit-learn, TensorFlow, or PyTorch required. Background in statistical analysis is essential.",
  ...
  // Content Writing
  {
    ...
    description:
      "Looking for a technical writer to create comprehensive documentation for our software products. Must have experience writing API documentation, user guides, and tutorials. Familiarity with developer tools and platforms is a plus.",
  ...
  },
  {
    ...
    description:
      "We need a creative copywriter to craft compelling copy for our marketing campaigns, website, and social media. Experience with persuasive writing, SEO optimization, and brand voice development required. Portfolio showcasing conversion-focused copy is essential.",
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div class="flex items-start justify-between mb-3">
                ...
                <div class="flex gap-2 ml-4">
                    <!-- Chat Icon linked to messaging.html -->
                    <button onclick="window.location.href='messaging.html'" class="p-2 hover:bg-gray-100 rounded-full">
...
function renderCollaborations() {
  ...
  if (currentFilter) {
    filteredCollabs = filteredCollabs.filter(
      (collab) => collab.field === currentFilter,
    );
  }
  ...
  listContainer.innerHTML = filteredCollabs
    .map((collab) => generateCard(collab))
    .join("");
